...
pros = [
  ...
  "Out-of-core algorithms are described as processing large datasets with no fixed limit on image count or resolution on a single machine",
...
cons = [
  ...
  "Minimum desktop specification lists an NVIDIA CUDA-capable GPU; full AMD GPU support was introduced only in version 2.2 (Windows)",
