...
gaussian_splatting = "WebODM supports Gaussian-splat export, import, conversion and browser viewing. Its documented self-hosted workflow exports training data for compatible external software (such as OpenSplat), then imports the trained model."
