+++
title = "WebODM"
description = "WebODM: free, open-source drone mapping software for maps, models and Gaussian splats. Runs on your own machine or the hosted Lightning cloud. Compare features, outputs and pricing."
weight = 1

[extra]
summary = "Free and open-source drone mapping software that turns aerial imagery into georeferenced orthomosaics, elevation models, point clouds, 3D models and Gaussian splats, self-hosted or run on its hosted Lightning cloud."
developer = "WebODM"
license = "AGPL-3.0"
open_source = true
...
key_features = [
  ...
  "Gaussian-splat workflow with training-data export, imported-model conversion and in-browser viewing",
...
pros = [
  ...
  "Supports export, import and browser viewing of Gaussian splats",
...
typical_workflow = [
  ...
  "For Gaussian splats, export training data, train it in compatible external software, then import the model for conversion and viewing",
...
sources = ["https://webodm.org", "https://github.com/WebODM/WebODM", "https://docs.webodm.org", "https://docs.webodm.org/gaussian-splats/"]
...
gaussian_splatting = "WebODM supports Gaussian-splat export, import, conversion and browser viewing. Its documented self-hosted workflow exports training data for compatible external software (such as OpenSplat), then imports the trained model; it is not native one-click training."
...
WebODM also supports a Gaussian-splat workflow: it exports imagery, camera poses and point-cloud data for training in compatible external software such as OpenSplat, then imports, converts and displays the trained splat model in its 3D viewer.
