...
accuracy_report = "Documented as 'Quality Reports' on the hosted WebODM Lightning edition (webodm.net)."
...
self_hosted = "webodm.org: 'Runs on your computer, even offline.'"
api = "webodm.org: NodeODX REST API and PyODX Python SDK; docs note API access with authentication."
